...
then
  ...
  exit 1
	...
	sudo forever -l /home/student/emptyContainerLog.log -a start /home/student/MITM/mitm.js -n $1 -i $emptyContainerIP -p 6900 --auto-access --auto-access-fixed 1 --debug --mitm-ip $hostIP
  ...
  sudo iptables --table nat --insert POSTROUTING --source $emptyMachine --destination 0.0.0.0/0 --jump SNAT --to-source $emptyContainerIP
	...
	sudo sysctl -w net.ipv4.conf.all.route_localnet=1
	sudo forever -l /home/student/personalContainer.log -a start /home/student/MITM/mitm.js -n $2 -i $personalContainerIP -p 6901 --auto-access --auto-access-fixed 1 --debug --mitm-ip $hostIP
  ...
  sudo iptables --table nat --insert POSTROUTING --source $personalMachine --destination 0.0.0.0/0 --jump SNAT --to-source $personalContainerIP
	...
	sudo sysctl -w net.ipv4.conf.all.route_localnet=1
	sudo forever -l /home/student/corporateContainer.log -a start /home/student/MITM/mitm.js -n $3 -i $corporateContainerIP -p 6903 --auto-access --auto-access-fixed 1 --debug --mitm-ip $hostIP
